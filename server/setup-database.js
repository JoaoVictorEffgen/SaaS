...
async function setupDatabase() {
  ...
  try {
    ...
    await connection.execute('DROP DATABASE IF EXISTS `SaaS`');
    
    // Criar o banco novamente
    console.log('🏗️ Criando banco de dados...');
    await connection.execute('CREATE DATABASE `SaaS` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci');
    
    // Usar o banco
    await connection.execute('USE `SaaS`');
    
    console.log('✅ Banco SaaS criado com sucesso!');
